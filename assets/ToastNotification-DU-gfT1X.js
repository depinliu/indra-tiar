import{c as n}from"./createLucideIcon-BIuKli9U.js";import{r as d,b as o,c as l,j as f,w as k,u as r,d as g,q as x,g as C,t as _,h as w,T as b,W as v}from"./index-BgjekdXS.js";const h="W3dd1ngS3cr3tK3y";function m(e,t){let c="";for(let a=0;a<e.length;a++)c+=String.fromCharCode(e.charCodeAt(a)^t.charCodeAt(a%t.length));return c}function p(e){return btoa(e).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"")}function T(e){for(e=e.replace(/-/g,"+").replace(/_/g,"/");e.length%4;)e+="=";return atob(e)}function B(e){try{const t=m(e,h);return p(t)}catch{return p(e)}}function I(e){try{const t=T(e);return m(t,h)}catch{return""}}function E(e,t){const c=JSON.stringify({id:e,name:t}),a=B(c);return`${window.location.origin}/invitation/${a}`}function O(e){try{const t=I(e);return JSON.parse(t)}catch{return null}}/**
 * @license lucide-vue-next v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const U=n("CalendarIcon",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]]);/**
 * @license lucide-vue-next v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
